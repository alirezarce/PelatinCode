! function (t) {
    ...
    }, t(".counter-list").length && t(".counter-list").countdown(), t(".single-select").length && t(".single-select").niceSelect(), window.addEventListener("contextmenu", (function (t) {
        t.preventDefault()
    ...
    //      ((!t.ctrlKey || t.keyCode != "U".charCodeAt(0)) && void 0))))
    // }
}(jQuery);