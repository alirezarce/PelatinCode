...
function delete_img(id)
{
    Swal.fire({
        ...
        {
            redirect(BACKEND_URL+"offlineCourse/edit/"+id+"?del=1");
        }
      })
}
function delete_img1(id)
{
    Swal.fire({
        ...
        if (result.isConfirmed) 
        {
            redirect(BACKEND_URL+"offlineCourse/edit/"+id+"?del=2");
        }
      })
}
function delete_img2(id)
{
    Swal.fire({
        ...
        if (result.isConfirmed) 
        {
            redirect(BACKEND_URL+"offlineCourse/edit/"+id+"?del=3");
        }
      })
}
function delete_img3(id)
{
    Swal.fire({
        ...
        if (result.isConfirmed) 
        {
            redirect(BACKEND_URL+"offlineCourse/edit/"+id+"?del=4");
        }
      })
}
...
function delete_medium_img(id)
{
    Swal.fire({
        ...
        if (result.isConfirmed) 
        {
            redirect(BACKEND_URL+"offlineCourse/edit/"+id+"?del=5");
        }
      })
}
