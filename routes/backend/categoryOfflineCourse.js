...
import CategoryOfflineCourseController from "../../controllers/backend/CategoryOfflineCourseController.js";
import AuthMiddleware from '../../middlewares/backend/auth.js';
const controller = new CategoryOfflineCourseController();
const route = Router();
try{
