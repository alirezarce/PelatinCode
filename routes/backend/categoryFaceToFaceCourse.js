...
import CategoryFaceToFaceCourseController from "../../controllers/backend/CategoryFaceToFaceCourseController.js";
import AuthMiddleware from '../../middlewares/backend/auth.js';
const controller = new CategoryFaceToFaceCourseController();
const route = Router();
try{
