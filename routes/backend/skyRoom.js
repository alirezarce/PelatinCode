...
import SkyRooMController from "../../controllers/backend/SkyRoomController.js";
import AuthMiddleware from '../../middlewares/backend/auth.js';
const controller = new SkyRooMController();
const route = Router();
try{
    ...
    route.get('/rooms',new AuthMiddleware().needAuth,controller.indexRooms);
    route.get('/getRoomUsers/:room_id',new AuthMiddleware().needAuth,controller.getRoomUsers);
}
catch(e){
