...
import BlogModel from '../../models/backend/blog.js';

export default class BlogController extends BackendController
{
    #url =  getEnv('BACKEND_URL') + 'blog/';
    ...
    async add(req,res){
        try{
            ...
            return res.render(this.templatePath + 'blog/add',data);
        }
        catch(e){
  ...
  {                    
    ...
    async index(req,res){
        try{
            ...
            return res.render(this.templatePath + 'blog/index',data);
        }
        catch(e){
            return super.toError(e,req,res);
        }
    ...
    async edit(req,res){
        try{
            ...
            if(this.input(req.query.del) == '1')
                {
                    const path = getPath() + 'media/img_blog' + row.img;
                    await unlink(path);
            ...
            return res.render(this.templatePath + 'blog/edit',data);
        }
        catch(e){
            return super.toError(e,req,res);
        }
